const messages = {
  ...
  rules: 'Reglas del clan Vzlan Warriors: \n' +
    ...
    '4. No hay regla de espejo en este clan, solo se pide la aldea a la cual tengas opción ' +
      'de sacar las tres (03) estrellas, siempre y cuando sea de tu mismo nivel de TH. ' +
      'En ocasiones se puede subir para hacer scout o bajar para limpiar, pero debe ' +
      'ser consultado con un líder. \n' +
    '5. No botinees JAMÁS a menos que se dé esa instrucción por parte ' +
      'del líder o colider(es).  \n' +
    '6. Por cada ataque que no hagas en guerra, se aplicará una (01) banca; ' +
